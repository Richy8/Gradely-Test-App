  ...
  <div>
    <Modal @closeModal="$emit('closeTriggered')">
      ...
      <div slot="modal-title">
        <span class="font-weight-bold">ADD SCHOOL USER</span>
      </div>
        ...
        <form action @submit.prevent>
          <div class="container">
            ...
            <div class="modal-body-row row">
              <label for="fullName" class="text-uppercase control-label color_grey_dark">NAME</label>
              <input
                type="text"
                id="fullName"
            ...
            <!-- EMAIL ADDRESS -->
            <div class="modal-body-row row">
              <label for="email" class="text-uppercase control-label color_grey_dark">EMAIL ADDRESS</label>
              <input
                type="email"
                id="email"
                v-model="form.email"
            ...
            <div class="modal-body-row row">
              <label
                for="email"
                class="text-uppercase control-label color_grey_dark w-100"
              >PHONE NUMBER</label>
          ...
          <div class="row d-flex justify-content-center align-items-center nowrap">
            ...
            >Cancel</button>
            <button type="submit" class="btn btn-md btn-accent ml-4">Add User</button>
          </div>
        </form>
      </div>
    </Modal>
