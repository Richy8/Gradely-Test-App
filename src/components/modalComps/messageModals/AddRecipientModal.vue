        ...
        <form action @submit.prevent>
          ...
          <div class="modal-body-row row mt-3 mb-1">
            <div class="col-12 d-flex flex-center">
              <button
                type="submit"
                class="btn btn-md btn-default-outline"
                @click="$emit('selctionCompleted')"
              >Done</button>
            </div>
          </div>
        </form>
...
import ParentList from "@/components/globalComps/MessageComps/ParentList";
import TeacherList from "@/components/globalComps/MessageComps/TeacherList";
