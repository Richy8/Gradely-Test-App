<template>
  <div>
    <div class="breakdown-card d-flex justify-content-start align-items-end nowrap">
      <!-- AVATAR -->
      <div class="avatar avatar-square">
        <img :src="require('@/assets/images/'+ topic_img +'')" :alt="topic" class="avatar-img">
      </div>
      ...
      <div class="topic-trend pb-1 w-100">
        ...
        <!-- PROGRESS BAR -->
        <div class="progress">
          <div class="progress-bar" :class="trend_color_bg" :style="'width:'+ trend_percent +'%'" role="progressbar"></div>
        </div>
      </div>
    </div>
  </div>
