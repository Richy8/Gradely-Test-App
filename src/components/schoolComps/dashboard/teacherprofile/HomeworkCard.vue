  ...
  <div>
    <div class="homework-card white rounded-5">
      <div class="d-flex justify-content-between align-items-center nowrap">
        ...
        <div class="d-flex justify-content-start align-items-center nowrap homework-info">
          ...
          <div class="avatar avatar-square avatar_sm_md">
            <div class="avatar-with-meta brand_inverse_light_bg">
              <div class="avatar-title brand_navy font-14">{{ day }}</div>
              <div class="avatar-meta color_text font-10">{{ setMonth }}</div>
            </div>
          </div>
        ...
        <!-- OPTION -->
        <div class="option">
          <router-link to="/school/dashboard/class/homework_review">
            <span class="font-weight-bold font-14 link-no-underline btn-link d-none d-sm-block">View</span>
            <span
              class="icon-caret-right border_grey_dark font-15 link-no-underline d-block d-sm-none"
            ></span>
          </router-link>
        </div>
      </div>
...
// MEDIA BREAK POINTS
//=====================
$xs: 450px; // EXTRA SMALL DEVICE
$sm: 576px; // SMALL DEVICE
$md: 767px; // MEDIUM DEVICE
$lg: 991px; //TABLET DEVICE
$xl: 1200px; // DESKTOP

//============================
// RESPONSIVE MAX WIDTH QUERY
//============================
