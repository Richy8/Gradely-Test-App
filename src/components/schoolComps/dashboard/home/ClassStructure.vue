...
<div class="class-structure-section">
    ...
    <div class="accordion-bottom" v-if="toggle_accordion">
        <div class="branches w-100 overflow-auto">
            ...
            <ClassBranch :class_branch="class_year+' - Gold'" class_code="688va6" />
            <ClassBranch :class_branch="class_year+' - Silver'" class_code="725bf9" />
            <ClassBranch :class_branch="class_year+' - Bronze'" class_code="441gt3" />
            <ClassBranch :class_branch="class_year+' - Diamond'" class_code="722hd6" />
            <!-- CLASS BRANCH COMPONENT -->
        </div>
        <!-- ADD BRANCH -->
        <div class="add-branch pointer w-50">
            <div class="undone"></div>
            <div class="label-text font-weight-bold brand_accent">Add more Branches</div>
        </div>
    </div>
