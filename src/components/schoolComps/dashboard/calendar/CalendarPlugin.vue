<template>
  <div class="calendar-plugin-section position-relative" :class="[border ? 'calendar-border' : '']">
    ...
    <div class="calendar-plugin">
      <!-- VIEW ONE -->
      <div class="date-view px-2" v-if="view_index === 0">
        <!-- LEFT NAV -->
        <div
      ...
      <!-- CALENDAR DIVIDER -->
      <div class="calendar-divider" v-show="create_new"></div>

      <!-- CREATE VIEW -->
      <div
        class="create-view pointer"
        v-show="create_new"
...
import MonthList from "@/components/schoolComps/dashboard/calendar/MonthList";
