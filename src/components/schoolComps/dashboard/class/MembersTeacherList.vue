<template>
  <div>
    ...
    >
      <div class="avatar avatar-square display--img">
        <img :src="dynamicImg(teacher_img)" alt class="avatar-img brand_navy_bg" v-if="teacher_img">
        <div
      ...
      <div class="tooltip--wrapper" v-if="show_tooltip">
        <div class="tooltip--content d-flex justify-content-start align-items-start nowrap">
          <!-- AVATAR -->
          <div class="avatar avatar_sm_md avatar-square tooltip--img">
            <img :src="dynamicImg(teacher_img)" alt class="avatar-img" v-if="teacher_img">
            <div
