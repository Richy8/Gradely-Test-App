        ...
        <div class="container-fluid modal-top pt-3 pb-4">
          ...
          <div class="post-modal-body">
            ...
            <div class="post-form-area w-100">
              <div class="user-name color_text font-weight-bold font-12-5 mb-2">Francis Sanni</div>

              <!-- INPUT FORM -->
              <!-- <textarea
                class="form-control mt-2 font-12-5 px-0 border-0"
...
export default {
  ...
  components: {
    ...
    PostInputOptions,
    NewPollsBlock: () =>
      import(/* NewPollsBlock */ "@/components/schoolComps/dashboard/class/class_feeds/NewPollsBlock")
  },
