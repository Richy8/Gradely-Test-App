<template>
  <div>
    <div class="school-display-banner w-100 position-relative">
      <div class="banner-overlay box-overlay brand_primary_bg overflow-hidden">
        <img v-lazy="dynamicImg(banner_img)" alt="SchoolBanner" class="img img-opacify">
      </div>
